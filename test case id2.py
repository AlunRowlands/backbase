...
class AddComputerInvalidYear(unittest.TestCase):
...
# wait to make sure the new window is loaded
        time.sleep(1)
        self.driver.find_element_by_id("name").send_keys("Aspire 2222")
        self.driver.find_element_by_id("introduced").send_keys("abcd-01-01")
        self.driver.find_element_by_id("discontinued").send_keys("2015-01-01")
