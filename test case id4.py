...
class AddComputerInvalidDay(unittest.TestCase):
...
# wait to make sure the new window is loaded
        time.sleep(1)
        self.driver.find_element_by_id("name").send_keys("Aspire 4444")
        self.driver.find_element_by_id("introduced").send_keys("2009-01-32")
