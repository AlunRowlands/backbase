...
# wait to make sure the new window is loaded
        time.sleep(1)
        self.driver.find_element_by_id("name").send_keys("Aspire 5555")
        self.driver.find_element_by_id("introduced").send_keys("2005-01-01")
        self.driver.find_element_by_id("discontinued").send_keys("20qw-01-01")
